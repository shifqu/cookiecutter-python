# Style Guide for {{cookiecutter.organization}} Code
...
Naming things is hard. {{cookiecutter.organization}} has a few strict guidelines on the usage of variable names, which hopefully will reduce some of the guesswork:
